...
-- Dumping database structure for db_astawms
CREATE DATABASE IF NOT EXISTS `db_astawms` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_astawms`;
...
CREATE TABLE IF NOT EXISTS `detail_instock` (
  ...
  `sku` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dumping data for table db_astawms.detail_outstock: ~5 rows (approximately)
...
-- Dumping data for table db_astawms.gudang: ~2 rows (approximately)
...
INSERT INTO `instock` (`idinstock`, `idgudang`, `instock_code`, `tgl_terima`, `jam_terima`, `datetime`, `user`, `kategori`) VALUES
	(1, 1, 'TSC20250426180242', '2025-04-26', '18:02:42', '2025-04-26 18:02:42', 'Admin', 'Barang Masuk'),
	(2, 2, 'TSC20250426180442', '2025-04-26', '18:04:42', '2025-04-26 18:04:42', 'Admin', 'Barang Masuk'),
	(3, 1, 'TSC20250426183526', '2025-04-26', '18:35:26', '2025-04-26 18:35:26', 'Admin', 'Barang Masuk'),
	(4, 2, 'TSC20250426183700', '2025-04-26', '18:37:00', '2025-04-26 18:37:00', 'Admin', 'Barang Masuk'),
	(5, 1, 'TSC20250426183712', '2025-04-26', '18:37:12', '2025-04-26 18:37:12', 'Admin', 'Barang Masuk');
...
-- Dumping data for table db_astawms.outstock: ~5 rows (approximately)
INSERT INTO `outstock` (`idoutstock`, `idgudang`, `outstock_code`, `tgl_keluar`, `jam_keluar`, `datetime`, `user`, `kategori`) VALUES
	(21, 1, 'TSC20250426183434', '2025-04-26', '18:34:34', '2025-04-26 18:34:34', 'Admin', 'Barang Keluar'),
	(22, 1, 'TSC20250426183445', '2025-04-26', '18:34:45', '2025-04-26 18:34:45', 'Admin', 'Barang Keluar'),
	(23, 2, 'TSC20250426183454', '2025-04-26', '18:34:54', '2025-04-26 18:34:54', 'Admin', 'Barang Keluar'),
	(24, 1, 'TSC20250426183731', '2025-04-26', '18:37:31', '2025-04-26 18:37:31', 'Admin', 'Barang Keluar'),
	(25, 2, 'TSC20250426183740', '2025-04-26', '18:37:40', '2025-04-26 18:37:40', 'Admin', 'Barang Keluar');
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `barcode` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `sni` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `created_by` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `updated_by` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `nama_role` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dumping data for table db_astawms.user: ~3 rows (approximately)
