...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2025 at 10:03 PM
...
--
-- Dumping data for table `detail_instock`
--

INSERT INTO `detail_instock` (`iddetail_instock`, `instock_code`, `sku`, `nama_produk`, `jumlah`, `sisa`, `keterangan`) VALUES
(1, 'TSC20250427220249', 'AECK-0101', 'Cempal Kotak White Beige - Asta', 10, 10, '');
...
(1, 1, 'TSC20250427220249', '2025-04-27', '22:02:49', '2025-04-27 22:02:49', 'Superadmin', 'Barang Masuk', 'Superadmin', '2025-04-27 22:02:49');
...
--
ALTER TABLE `detail_instock`
  MODIFY `iddetail_instock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `instock`
  MODIFY `idinstock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `product_stock`
  MODIFY `idproduct_stock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
