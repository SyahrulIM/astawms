...
-- Dumping structure for table db_astawms_27012026.acc_accurate
...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.acc_accurate_detail
...
) ENGINE=InnoDB AUTO_INCREMENT=152211 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.acc_lazada
...
-- Dumping structure for table db_astawms_27012026.acc_lazada_additional
...
-- Dumping structure for table db_astawms_27012026.acc_lazada_detail
...
-- Dumping structure for table db_astawms_27012026.acc_lazada_detail_details
...
-- Dumping structure for table db_astawms_27012026.acc_shopee
...
-- Dumping structure for table db_astawms_27012026.acc_shopee_additional
...
-- Dumping structure for table db_astawms_27012026.acc_shopee_bottom
...
-- Dumping structure for table db_astawms_27012026.acc_shopee_detail
CREATE TABLE IF NOT EXISTS `acc_shopee_detail` (
  ...
  KEY `idx_pay_date` (`pay_date`),
  KEY `idx_no_faktur` (`no_faktur`,`idacc_shopee_detail`)
) ENGINE=InnoDB AUTO_INCREMENT=207890 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.acc_shopee_detail_details
...
) ENGINE=InnoDB AUTO_INCREMENT=165145 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.acc_tiktok
...
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.acc_tiktok_additional
...
-- Dumping structure for table db_astawms_27012026.acc_tiktok_detail
CREATE TABLE IF NOT EXISTS `acc_tiktok_detail` (
  ...
  KEY `idx_pay_date` (`pay_date`)
) ENGINE=InnoDB AUTO_INCREMENT=4412 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.acc_tiktok_detail_details
...
) ENGINE=InnoDB AUTO_INCREMENT=11906 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.analisys_po
CREATE TABLE IF NOT EXISTS `analisys_po` (
  ...
  `type_po` varchar(50) DEFAULT NULL,
...
-- Dumping structure for table db_astawms_27012026.city
...
-- Dumping structure for table db_astawms_27012026.ci_sessions
...
-- Dumping structure for table db_astawms_27012026.customer
...
-- Dumping structure for table db_astawms_27012026.delivery_file
...
-- Dumping structure for table db_astawms_27012026.delivery_note
...
) ENGINE=InnoDB AUTO_INCREMENT=809 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.delivery_note_log
...
) ENGINE=InnoDB AUTO_INCREMENT=3179 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.detail_analisys_po
CREATE TABLE IF NOT EXISTS `detail_analisys_po` (
  ...
  `qty_packing_list` int DEFAULT NULL,
...
-- Dumping structure for table db_astawms_27012026.detail_instock
...
-- Dumping structure for table db_astawms_27012026.detail_outstock
...
) ENGINE=InnoDB AUTO_INCREMENT=16437 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.district
...
-- Dumping structure for table db_astawms_27012026.gudang
...
-- Dumping structure for table db_astawms_27012026.instock
CREATE TABLE IF NOT EXISTS `instock` (
  ...
  `distribution_date` datetime DEFAULT NULL,
  `number_plate` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `driver` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `handphone_driver` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `container_instock` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for table db_astawms_27012026.outstock
...
-- Dumping structure for table db_astawms_27012026.postal_code
...
-- Dumping structure for table db_astawms_27012026.ppl_bank_password
...
-- Dumping structure for table db_astawms_27012026.ppl_devices
...
-- Dumping structure for table db_astawms_27012026.ppl_devices_bank_password
...
-- Dumping structure for table db_astawms_27012026.ppl_employee
...
-- Dumping structure for table db_astawms_27012026.ppl_pic_bank_password
...
-- Dumping structure for table db_astawms_27012026.ppl_places
CREATE TABLE IF NOT EXISTS `ppl_places` (
  `idplace` int NOT NULL AUTO_INCREMENT,
  `place_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for table db_astawms_27012026.ppl_presence
...
-- Dumping structure for table db_astawms_27012026.ppl_presence_detail
...
) ENGINE=InnoDB AUTO_INCREMENT=14580 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.ppl_time_off
...
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Data exporting was unselected.

-- Dumping structure for table db_astawms_27012026.product
...
-- Dumping structure for table db_astawms_27012026.product_stock
...
-- Dumping structure for table db_astawms_27012026.province
...
-- Dumping structure for table db_astawms_27012026.role
...
-- Dumping structure for table db_astawms_27012026.subdistrict
...
-- Dumping structure for table db_astawms_27012026.user
