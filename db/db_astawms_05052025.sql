...
-- Dumping data for table astahome_wms.detail_outstock: ~141 rows (approximately)
...
-- Dumping data for table astahome_wms.outstock: ~2 rows (approximately)
...
-- Dumping data for table astahome_wms.product_stock: ~89 rows (approximately)
