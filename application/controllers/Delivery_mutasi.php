...
class Delivery_mutasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->db->where('delivery_note.kategori', 3);
        ...
        $this->load->view('Delivery_mutasi/v_delivery_mutasi');
    }
    ...
    public function finalDelivery()
    {
        ...
        $cek = $this->db->get_where('delivery_note', [
            'iddelivery_note' => $id,
            'kategori' => 3 // Ensure this is for manual deliveries
        ])->row();
    ...
    ');
        ...
        $this->db->where('delivery_note.status', 1);
        $this->db->where('delivery_note.kategori', 3); // Manual deliveries only
