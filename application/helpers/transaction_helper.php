...
{
	return number_pending_verification_delivery_note() + number_pending_validasi_delivery_note() + number_pending_final_delivery_note() + number_pending_verification_delivery_manual() + number_pending_validasi_delivery_manual() + number_pending_final_delivery_manual();
}
