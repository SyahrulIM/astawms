...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#addDeliver">
        <i class="fa-solid fa-plus"></i> Tambah File Surat Jalan Supplier
    </button>
    <?php } ?>
    ...
    <div class="modal fade" id="addDeliver" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addDeliverLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('Delivery_file/createDelivery') ?>">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addDeliverLabel">Tambah File Surat Jalan Supplier</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="inputDateReceived" class="form-label">Tanggal Barang Diterima</label>
                            <div class="input-group">
                                <input type="date" class="form-control" id="inputDateReceived" name="inputDateReceived" required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="inputNameSupplier" class="form-label">Nama Supplier</label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="inputNameSupplier" name="inputNameSupplier" required placeholder="Nama Supplier">
                            </div>
                        </div>
                        <div class="mb-3">
            ...
            <table id="tableproduct" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $dvalue->name_supplier; ?></td>
                        <td><?php echo $dvalue->created_date; ?></td>
                        <td><?php echo $dvalue->date_received; ?></td>
                        <td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger btn-delete" data-id="<?= $dvalue->iddelivery_file ?>" data-toggle="modal" data-target="#deleteModal">
...
<script>
    ...
    $(document).on('click', '.btn-delete', function() {
        let id = $(this).data('id');
        let deleteUrl = "<?= base_url('delivery_file/deleteDelivery?id=') ?>" + id;
